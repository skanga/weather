...
Thanks for your interest in contributing! This project is intentionally simple — plain HTML, CSS, and vanilla JavaScript with no runtime build step or frameworks.
