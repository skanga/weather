...
const TRANSLATIONS = {
    en: {
        ...
        locationUnavailable: 'Could not get your current location. Allow location permission, turn on device location, or search by city.',
        back: '← Back',
        ...
        radarUnavailable: 'Radar unavailable. Try refreshing; radar providers may be temporarily unavailable.',
        ...
        failedToLoadWeather: 'Forecast request failed. Check your connection and try again.',
        failedToLoadWeatherStatus: 'Forecast provider returned HTTP {status}. Try again, or try another location.',
        failedToLoadWeatherRateLimit: 'Forecast provider is rate limiting requests. Wait a minute, then try again.',
        failedToLoadWeatherTimeout: 'Forecast request timed out. Check your connection and try again.',
        failedToRenderWeather: 'Weather data loaded, but the page could not render it. Reload the page; if it repeats, report the console error.',
        retry: 'Retry',
        hide: 'Hide',
        close: 'Close',
    ...
    pl: {
        ...
        wind: 'Wiatr',
        windDirN: 'Północ',
        windDirNE: 'Północny wschód',
        windDirE: 'Wschód',
        windDirSE: 'Południowy wschód',
        windDirS: 'Południe',
        windDirSW: 'Południowy zachód',
        windDirW: 'Zachód',
        windDirNW: 'Północny zachód',
        gusts: 'Porywy',
        airQuality: 'AQI',
    ...
    ru: {
        ...
        wind: 'Ветер',
        windDirN: 'Север',
        windDirNE: 'Северо-Восток',
        windDirE: 'Восток',
        windDirSE: 'Юго-Восток',
        windDirS: 'Юг',
        windDirSW: 'Юго-Запад',
        windDirW: 'Запад',
        windDirNW: 'Северо-Запад',
        gusts: 'Порывы',
        airQuality: 'AQI',
    ...
    hi: {
        ...
        wind: 'हवा',
        windDirN: 'उत्तर',
        windDirNE: 'उत्तर-पूर्व',
        windDirE: 'पूर्व',
        windDirSE: 'दक्षिण-पूर्व',
        windDirS: 'दक्षिण',
        windDirSW: 'दक्षिण-पश्चिम',
        windDirW: 'पश्चिम',
        windDirNW: 'उत्तर-पश्चिम',
        gusts: 'झोंके',
        airQuality: 'AQI',
...
// Each language maps to one or more flags to show side by side (e.g. English
// shows both US and UK flags; Portuguese shows Brazil and Portugal).
const LANGUAGE_FLAGS = {
    en: [{ path: '/img/flags/en.png', alt: 'US' }, { path: '/img/flags/gb.png', alt: 'UK' }],
    es: [{ path: '/img/flags/es.png', alt: '' }],
    fr: [{ path: '/img/flags/fr.png', alt: '' }],
    de: [{ path: '/img/flags/de.png', alt: '' }],
    it: [{ path: '/img/flags/it.png', alt: '' }],
    pt: [{ path: '/img/flags/pt-br.png', alt: 'BR' }, { path: '/img/flags/pt-eu.png', alt: 'PT' }],
    nl: [{ path: '/img/flags/nl.png', alt: '' }],
    pl: [{ path: '/img/flags/pl.png', alt: '' }],
    sv: [{ path: '/img/flags/sv.png', alt: '' }],
    ru: [{ path: '/img/flags/ru.png', alt: '' }],
    ja: [{ path: '/img/flags/ja.png', alt: '' }],
    zh: [{ path: '/img/flags/zh.png', alt: '' }],
    ko: [{ path: '/img/flags/ko.png', alt: '' }],
    ar: [{ path: '/img/flags/ar.png', alt: '' }],
    hi: [{ path: '/img/flags/hi.png', alt: '' }]
};
...
function t(key, vars) {
    ...
    let str = key in langTable ? langTable[key] : (key in TRANSLATIONS.en ? TRANSLATIONS.en[key] : key);
